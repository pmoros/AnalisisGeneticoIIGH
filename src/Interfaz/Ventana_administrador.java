...
public class Ventana_administrador extends JFrame {
	...
	public Ventana_administrador() {
		setTitle("An\u00E1lisis IIGH (Administrador)");
		...
		btnNewButton_1.setBounds(247, 170, 101, 23);
		contentPane.add(btnNewButton_1);
		
		JButton btnNewButton_2 = new JButton("Administrar perfiles");
		...
		btnNewButton_2.setBounds(152, 214, 131, 23);
